...
hypoxiaHK <- hypoxiaTested[hypoxiaTested$gene_family == "HK",]
...
plot(hypoxiaHK$value_2,hypoxiaHK$value_1, xlim = c(0,100), ylim = c(0,100), ylab = "FKPM, Hypoxic Condition", xlab = "FKPM, Normal Condition")
```
...
points(hypoxiaHK$value_2,hypoxiaHK$value_1, col = "red", pch = 19)
